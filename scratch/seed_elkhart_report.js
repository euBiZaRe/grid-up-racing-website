...
<div style="text-align: center; margin: 2rem 0;">
  <img src="assets/reports/elkhart-lake-multiclass.png" alt="Multiclass Action at Road America" style="max-width: 100%; border-radius: 8px; border: 1px solid var(--glass-border); box-shadow: 0 4px 20px rgba(0,0,0,0.5);">
...
<div style="text-align: center; margin: 2rem 0;">
  <img src="assets/reports/elkhart-lake-gt3-battle.jpg" alt="Harrison Holliday and Michael O'Dell GT3 Battle" style="max-width: 100%; border-radius: 8px; border: 1px solid var(--glass-border); box-shadow: 0 4px 20px rgba(0,0,0,0.5);">
