...
const RESULT_DATA = {
    rawUrl: "assets/results/July1126.png",
    teamAsset: "assets/results/July1126.png",
...
async function main() {
    try {
        console.log("Writing July 11 recent result card to Firestore...");
        await db.collection("race_results").doc("July1126").set(RESULT_DATA);
        console.log("SUCCESS: July 11 recent result card added to Firestore!");
    } catch(e) {
